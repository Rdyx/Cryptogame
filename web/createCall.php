        ...
        <form class="col-sm-6" action="/web/createdCall.php" method="post">
            <table class="table text-center">
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <textarea class="text-center form-control" type="text" id="description" name="description" rows="5" placeholder="Infos supplémentaires sur le call (optionnel)"></textarea>
                    </td>
                </tr>
            </table>
